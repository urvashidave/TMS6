...
<script>
                         $(window).load(function()  { 
                           ...
                           $("#expandall").click(function(){
                                  //alert("clicked");
                                   $('#tree2').treegrid('expandAll');
                               //document.getElementById("load").innerHTML = "<img src='images/load.gif' width='2%'> Loading...";
                           });
                           $("#collapseall").click(function(){
                                   // alert("clicked");
                                   $('#tree2').treegrid('collapseAll');
                               //document.getElementById("load").innerHTML = "<img src='images/load.gif' width='2%'> Loading...";
                           });
...
<body>
		...
		<section>
			<div>
		<form>
                    <input type="button" id="expandall" value="ExpandAll">
                    <input type="button" id="collapseall" value="CollapseAll">
